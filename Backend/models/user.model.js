...
const ModelUser = mongoose.Schema({
    ...
    imageUrl: { type: String, required: true, default: "https://img.favpng.com/25/1/17/avatar-user-computer-icons-software-developer-png-favpng-7SbFpNeqKqhhTrrrnHFUqk6U4.jpg" },
